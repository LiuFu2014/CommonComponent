...
//using a=Oracle.DataAccess.Client;
using System.Data.OracleClient;
...
namespace SQLHelper
{
    ...
    public abstract class DbHelperOra
    {
        ...
        public static string connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["connstrorcl"].ConnectionString;
        public static string connectionString2 = System.Configuration.ConfigurationManager.ConnectionStrings["connstroledb"].ConnectionString;
        public DbHelperOra()
        {
        }
        ...
        /// <returns></returns>
        public static DataSet RunPro(string procname, OleDbParameter[] paras)
        {
        ...
        ///// <param name="paras"></param>
        ///// <returns></returns>
        //public static DataSet RunProc(string procname, OracleParameter[] paras)
        //{
        //    using (OracleConnection conn=new OracleConnection(connectionString))
        //    {
        //        OracleCommand cmd = new OracleCommand();
